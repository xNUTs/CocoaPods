...
module Pod
  ...
  class Validator
    ...
    def xcodebuild
      ...
      command += %w(CODE_SIGN_IDENTITY=- -sdk iphonesimulator) if consumer.platform_name == :ios
      command += %w(CODE_SIGN_IDENTITY=- -sdk watchsimulator) if consumer.platform_name == :watchos
